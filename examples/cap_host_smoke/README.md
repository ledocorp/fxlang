...
In-language `FsCap` / `io_cap` — **FX-DYN-1** ([CAPABILITY_REGIONS_LITE.md](../../docs/specs/CAPABILITY_REGIONS_LITE.md), `examples/cap_regions_*`). Same region physics; not a soft dialect.
