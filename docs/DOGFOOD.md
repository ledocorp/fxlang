...
Apps 1–5 live under `examples/dogfood_*`. The language package may ship a subset
(living dogfood / tools / composition demos); if a folder is missing from your
checkout, use the matching GitHub release assets.
...
- Link/host + live keypad loop without changing language visibility rules
...
| Rule | Meaning |
|------|---------|
| Visibility | Effects, regions, and grow vs slot mut stay visible |
